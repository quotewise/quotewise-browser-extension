...
4. Paste `probes/other-features-probe.js` when deciding whether metadata, hydration, accessible labels, or stable identifiers should inform selector updates.
